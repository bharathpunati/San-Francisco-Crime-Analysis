...
crime<-read.csv('/Users/bharathpunati/Desktop/NORTHEASTERN/Computation /project/crime1.csv')
...
# Import dataset
crimedf <- read.csv("/Users/bharathpunati/Desktop/NORTHEASTERN/Computation /project/crime.csv")
    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidRow(  
          ...
          column (7,
                  box(width = 12,
                      title = "District wise Yearly analysis(2015-2018)",
                      color = "green", ribbon = TRUE, title_side = "top right",
